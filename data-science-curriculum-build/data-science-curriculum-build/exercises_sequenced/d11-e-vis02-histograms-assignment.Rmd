...
**Observations**
- There seems to be a spike of diamonds at every 0.1 interval, then graudually decreases as it approached to the next 0.1 interval. there is significantly less diamonds at intervals 0.2, 0.6 and 0.8, which is interesting. the slope from 0.5 is also a lot smaller compared to other slopes (ie 0.9, 0.3 etc)
