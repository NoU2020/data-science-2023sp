...
**Observations**:
- Hypothesis 1 does not seem correct, there are way more ideal diamonds than other cuts.
- This could be ideal diamonds are more valuable/popular so less valuable cuts aren't made/sold
...
**Observations**:
- Well I can only see lines, I can't really see the different data points or the amount of data. I cant tell anything from this graph.
...
**Observations**:
- On average, ideal actually seems to be cheaper than fair, though it could be that theres less fair cuts than ideal cuts and maybe it has a small data set?
...
**Observations**:
- Hmm, I can see Cut is not a definitive factor in determining the price of diamonds. However, it is still unclear if carat is a bigger/smaller influence from this graph alone.
