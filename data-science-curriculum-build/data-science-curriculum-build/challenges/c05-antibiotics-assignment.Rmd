...
- What is your response to the question above?
  - In general, penicillin is effective against bacteria with positive gram and fairly ineffective against bacteria with negative gram. For the positive gram bacteria, either neomycin or penicillin are usually effective(effectiveness>0.1), while steptomycin is not super effective in general for positive grams. For negative gram bacteria, penicillin in general is not super effective (effectiveness>0.1), and the neomycin and streptomycin are more effective than penicillin, but can both be ineffective (eg aerobacter aerogenes).
- Which of your visuals above (1 through 5) is **most effective** at helping to answer this question?
  -  The first is particularly helpful for make distinction between the effectiveness between the different antibiotics on specific bacteria, while graph 2 is helpful in identifying specific trends with antibiotics and grams. 
- Why?
  - graph 1 is essentially 16 independent graphs, so while it is hard to make comparison between individual graphs, it is helpful in identifying how the different antibiotics vary within a specific bacteria. graph 2 is a scatter plot and colored all the different bacteria differently. It is not helpful is recognizing specific bacteria because of the overlapping colors. It is helpful in recognizing general trends with grams and antibiotics.
...
*Observations*
- What is your response to the question above?
  - Given that relationship between MIC and biological structure, similar MIC values across bacteria might relate to similar biological structure, hence renaming the bacteria based on previously unobserved biological structure via antibiotic resistances might be a possibility
- Which of your visuals above (1 through 5) is **most effective** at helping to answer this question?
  - Graph 3 was the most effective.
- Why?
  - I could compare the effectiveness of each antibiotic on each bacteria with relative ease and i can reference the relative effectiveness of each antibiotic for the different bacterias. This is my favorite graph.
