...
```
    ...
    ## $ e_std       <dbl> 268.2421
    ## $ e_var       <dbl> 71953.85
    ## $ mu_mean     <dbl> 0.3212308
    ## $ mu_std      <dbl> 0.006742745
    ## $ mu_var      <dbl> 4.546462e-05
    ## $ thick_mean  <dbl> 0.05215385
    ## $ thick_std   <dbl> 0.0248124
    ## $ thick_var   <dbl> 0.0006156554

**Observations**:

- Is there “one true value” for the material properties of Aluminum?
  - No, even though when the thickness, alloy and angle are all the
    same, it is still possible for the material to have different
    elasticity and mu.
- How many aluminum alloys are in this dataset? How do you know?
  - here is 1 type of aluminum alloy, and it is al_24st
...
- Does this graph support or contradict the claim above?
  - The graph supports the claim to an extent. It is clear that when the
    thickness is within a certain range (ie between 0.022 and 0.064),
    the elasticity tends to stay in 10700 and 10300. However, when the
    thickness reaches 0.081, Elasticity vary significantly from others.
    The graph would therefore need to cover a wider range of
    thickness/amount of alloy to extensively prove that Elasticity is a
    material property to show that the 0.081 thickness might just be an
    outlier.
