...
- Write your observations here!
  - While the distinctness frequency is the same, the specific mean velocity varies quite a bit
- Why might your table differ from Michelson's?
  - there could be rounding or calculation differences in computing vs human calculation.
...
- Is Michelson's estimate of the error (his uncertainty) greater or less than the true error?
  - The uncertainty error is smaller than the true error, which meant Michelson thought he was more accurate than he actually was.
- Make a quantitative comparison between Michelson's uncertainty and his error.
  - Michelson's uncertainty is 51, which is the amount of variation in the measurements that would cause the measurement to be inaccurate. However the true error is 151.542, which is significantly larger than 51. This might suggest that the method and equipment of measurement likely had more impact that the variation in the measured data due to how old this experiment was (1879).
...
**Observations**:
Similarities
- The overall increase and decrease peaks and valleys occur at roughly the same dates. The range stays fairly consistent throughout the measurement dates between 299900 and 300000. The measurements between Jun 16 and 23 are fairly similar between real and simulated.
Differences
- The measurements at June 9th is higher than the simulated velocity, while on June 25th the simulated velocity is higher than the real velocity. 
...
- The distinctness 3's measurements cluster more closely towards the mean than distinctness 2 and 1
-There also seems to be a correlation with warmer and cooler temperatures.When the temperatures are more extreme (i.e. around 60s or 90s), more deviations tend to appear.
-Based on these observations, there doesn't appear to be an obvious/explicit reason as to why Michelson's uncertainty error was less than the true error based on my observations.
