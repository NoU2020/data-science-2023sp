...
- Which correlations are significantly nonzero?
  - I would say both highschool GPA and both SAT were significantly nonzero.
...
- By itself, how well does `both_SAT` predict `univ_GPA`?
  - by itself a 100 increase in sat means roughly a 0.2 increase in GPA, which is not insignificant, but not a good enough indicator of GPA. The r squared value is less thahn 0.5, which means it is pretty weak.
