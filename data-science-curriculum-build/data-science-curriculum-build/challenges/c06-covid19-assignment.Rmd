...
- The cases per 100k for Loving, Texas exceeded 100k, which meant either the reporting is incorrect or multiple ppl got better and re-contracted covid. Only Loving appeared in both top 10 cases and deaths, wich could be due to their especially small sample size of 102 population. They are also generally southern republican states. The maximum cases sky generlly clustered near 2022-05-11 until 2022-05-13, while the maximum deaths generally happened from 2022-02 until 2022-05. They all tend to have a small sample size of under 20k population per county.
...
```
Observation:
Generally the death percentage after contracting the virus ranges between 0.15 to 0.001 percent, with the average around 0.025 percent. The larger the population, the more it leans towards 0.02. There is a lot of variation with smaller population sizes, which is to be expected as they are more prone to extreme cases. 
