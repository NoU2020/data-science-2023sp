...
**Observations**: - Write your observations here! - While the
distinctness frequency is the same, the specific mean velocity varies
quite a bit - Why might your table differ from Michelson’s? - there
could be rounding or calculation differences in computing vs human
calculation.
...
**Observations**: Similarities - The overall increase and decrease peaks
and valleys occur at roughly the same dates. The range stays fairly
consistent throughout the measurement dates between 299900 and 300000.
The measurements between Jun 16 and 23 are fairly similar between real
and simulated. Differences - The measurements at June 9th is higher than
the simulated velocity, while on June 25th the simulated velocity is
higher than the real velocity.
...
df_q2 %>%
  ...
  theme_minimal() +
  labs(
    x = "Temperature of Measurement (1879)",
    y = "Velocity (in Vacuum)"
  )
```
