...
- The variables are Class, sex, age, survived and n, which stands for
  the amount of people in that category
...
- Are there any differences?
  - Yes, according to the wikipedia the total amount of estimated
    passengers is around 2224.
- If yes, what might account for those differences?
  - It could be 23 people snuck up on board without being documented, or
    that during documentation human error happened, or that some people
    do not fit into the 4 binary categories.
  - …
...
- In 1st and 2nd class, the number of female survivors are significantly
  higher than the male survivors. In 3rd class its roughly the same with
  female being slightly higher, and in the crew male survivors were
...
- Is there anything *fishy* going on in your plot?
  - There *is* something fishy going on. Despite the numbers being
    higher, the proportions of the Male to Female survivors of the 1st
    and 2nd class are the same. This means all of them survived. And in
    the 3rd class and crew, despite the actual numbers being lower,
    there are a higher proportion of female survivors compared to male.
    Also the 1st and 2nd class have nearly 100% survival rates, which is
    a bit weird, cuz I think more people died.
...
- If you saw something *fishy* in q4 above, use your new plot to explain
  the fishy-ness.
  - The child and the adult graphs were overlapping!! This was why there
    was such a high survival rate for 1st and 2nd class, because the
    children are overlapping the adults
