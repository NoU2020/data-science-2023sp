...
- Is there "one true value" for the material properties of Aluminum?
  - No, even though when the thickness, alloy and angle are all the same, it is still possible for the material to have different elasticity and mu.
...
- there doesn't quite seem to be a visible relationship angle angle and mu. looking at both the box plot and scatter plot, it doesnt seem like the angle influences the mu much if at all.
...
- Does this graph support or contradict the claim above?
  - The graph supports the claim to an extent. It is clear that when the thickness is within a certain range (ie between 0.022 and 0.064), the elasticity tends to stay in 10700 and 10300. However, when the thickness reaches 0.081, Elasticity vary significantly from others. The graph would therefore need to cover a wider range of thickness/amount of alloy to extensively prove that Elasticity is a material property to show that the 0.081 thickness might just be an outlier. 
